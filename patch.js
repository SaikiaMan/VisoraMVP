        ...
        <div class="workspace-grid" id="mainWorkspace" style="display: none;">
          ...
          <aside class="panel chat-panel glass-panel" style="display: flex; flex-direction: column;">
            ...
            <div id="tab-doubt" class="tab-content" style="display: flex; flex-direction: column; flex: 1;">
              <div id="chatLog" class="chat-log" aria-live="polite" style="flex: 1; min-height: 300px;">
            ...
            <!-- Tab Content: Notes -->
            <div id="tab-notes" class="tab-content" style="display: none; align-items: center; justify-content: center; flex: 1; text-align: center; flex-direction: column;">
            ...
            <!-- Tab Content: Quiz -->
            <div id="tab-quiz" class="tab-content" style="display: none; align-items: center; justify-content: center; flex: 1; text-align: center; flex-direction: column;">
            ...
            <div id="tab-weak" class="tab-content" style="display: none; align-items: center; justify-content: center; flex: 1; text-align: center; flex-direction: column;">
...
const startIdx = html.indexOf('<section id=\"learningWorkspace\" class=\"workspace-section\">');
let endStr = '</section>\\n      <section class=\"philosophy-section\">';
let endIdx = html.indexOf(endStr);
if (endIdx === -1) {
  // Try another fallback
  endIdx = html.indexOf('</section>', startIdx + 100);
}

if (startIdx !== -1 && endIdx !== -1) {
  html = html.substring(0, startIdx) + newWorkspace + html.substring(endIdx);
  fs.writeFileSync('frontend/index.html', html);
  console.log('Successfully updated index.html');
} else {
  console.log('Failed to find workspace section boundary.', startIdx, endIdx);
}
